...
class ConsoleMenu():
    ...
    def __init__(self):       
        self.parser = utilities.LanguageParser()        
    ...
    def print_action(self, command: str, msg: str) -> None:
        print(colored('Command: ', 'green') + colored(command, 'yellow') + ' ' + colored('msg', 'grey'))
    ...
    # #Method to identify if the current instance is a server, client or neither
    ...
    # #Create makefile folder for program to read from
    # def set_initial_folder(self) -> None:
...
class ServerManager():
    ...
    def client_receive_msg(self) -> str:        
        ...
        while True:
            ...
            # print(data)
            if data:
                # print(colored(data.decode(), 'blue'))
                print(data.decode())
                break
    ...
    def attend_server_clients(self, sock: socket.socket, addr: str) -> None:
        ...
        while True:
            ...
            # print(f'This is the message --> {user_msg}')
