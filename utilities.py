...
#Just reads from file y devuelve como un string el contenido, por lo que veo no se va a necesitar...
class FileReader():
    @staticmethod
...
#TODO Tiene mucha cosa innecesaria, primero voy a tratar de hacer el servidor y el cliente y entonces pongo a terminar el lexer
#Lexer
class LanguageLexer():
...
class LanguageParser():
    ...
    def verify_menu(self):
        if not self.menu:
            print("No menu manager set, adioj...")
            sys.exit(1)
    ...
    precedence = (
        ...
        # ('right', 'UMINUS'),#Caso para verificar que sea negativo y no una resta        
    )
